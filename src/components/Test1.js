            ...
            <div class="card border-info mb-3 mb-3 container-lg" style={{maxWidth:500}}>
               <div class="card-header">La perte du goût</div>
                ...
                <img src="" class="im" alt=""/>
                 <p class="card-text">- La perte du goût, c'est quand vous ne pouvez plus reconnaître le goût d'un aliment.Par exemple, le poulet a le même goût que le poisson.</p>
             </div>
             </div>
             <div class="card border-info mb-3 mb-3 container-lg" style={{maxWidth:500}}>
               <div class="card-header">La perte de l'odorat</div>
                <div class="card-body ">
                <img src="" class="im" alt=""/>
                 <p class="card-text">- La perte de l'odorat, c'est quand vous ne sentez plus les odeurs.Par exemple, vous ne pouvez plus sentir l'odeur du poulet qui sort du four.</p>
             </div>
            </div>
        ...
        <div className="test1">
            ...
            <div class="card border-info mb-3 mb-3 container-lg" style={{maxWidth:500}}>
               <div class="card-header">Le mal de gorge</div>
                <div class="card-body ">
                <img src="" class="im" alt=""/>
                 <p class="card-text">- Un mal de gorge,c’est quand vous ressentez un irritation ou une gêne au niveau de votre gorge.</p>
             </div>
            </div>
            <div class="card border-info mb-3 mb-3 container-lg" style={{maxWidth:500}}>
               <div class="card-header">La courbaturet</div>
                <div class="card-body ">
                <img src="" class="im" alt=""/>
                 <p class="card-text">-La courbature, c'est une douleur musculaire.On peut ressentir des courbatures quand on a fait trop de sport ou quand on est malade.Les muscles du corps sont fatigués,donc ils font mal.</p>
             </div>
            </div>     
        </div>
        </div>
        ...
        <div className="test1">
            ...
            <div class="card border-info mb-3 mb-3 container-lg" style={{maxWidth:500}}>
               <div class="card-header">La diarrhée</div>
                <div class="card-body ">
                <img src="" class="im" alt=""/>
                 <p class="card-text">- La diarrhée, c'est aller aux toilettes plus souvent que d'habitude.Il faut être allé aux toilettes au moins 3 fois dans la journée.La consistance de votre caca est molle ou liquide.La quantité est plus importante.</p>
             </div>
            </div> 
        ...
        <div className="test1">
            ...
            <div class="card border-info mb-3 mb-3 container-lg" style={{maxWidth:500}}>
               <div class="card-header">La fatigue inhabituelle</div>
                <div class="card-body ">
                <img src="" class="im" alt=""/>
                 <p class="card-text">-La fatigue inhabituelle, c'est une forme de fatigue que vous n'avez pas l'habitude de ressentir.Votre corps est plus faible.Les douleurs liées à cette fatigue sont plus importantes.</p>
             </div>
            </div>
        </div>
        ...
        <div className="test1">
            ...
            <div class="card border-info mb-3 mb-3 container-lg" style={{maxWidth:500}}>
               <div class="card-header">Le repos</div>
                <div class="card-body ">
                <img src="" class="im" alt=""/>
                 <p class="card-text">-La fatigue que vous ressentez est tellement importante que vous avez besoin de vous reposer souvent.Vous vous reposez la moitié de la journée.</p>
             </div>
            </div>
        </div>
        ...
        <div className="test1">
            ...
            <div class="card border-info mb-3 mb-3 container-lg" style={{maxWidth:500}}>
               <div class="card-header">L'impossibilité de manger ou de boire</div>
                <div class="card-body ">
                <img src="" class="im" alt=""/>
                 <p class="card-text">-Être dans l'impossibilité de manger ou de boire,c'est que vous n'arrivez plus à avaler ni nourriture ni boisson.Vous ressentez du dégoût quand vous voyez de la nourriture.</p>
             </div>
            </div>
        </div>
        ...
        <div className="test1">
            ...
            <div class="card border-info mb-3 mb-3 container-lg" style={{maxWidth:500}}>
               <div class="card-header">Le manque de souffle</div>
                <div class="card-body ">
                <img src="" class="im" alt=""/>
                 <p class="card-text">-Un manque de souffle est inhabituel,quand vous avez plus de mal à respirer que les autres jours.Par exemple vous êtes plus essouflé quand vous parlez ou quand vous montez l'escalier.</p>
             </div>
            </div>
        </div>
        ...
        <div className="test1">
            ...
            <div class="card border-info mb-3 mb-3 container-lg" style={{maxWidth:500}}>
               <div class="card-header">L'âge</div>
                <div class="card-body ">
                <img src="" class="im" alt=""/>
                 <p class="card-text">-Votre âge peut être un facteur de risque.Un facteur de risque est quelque chose qui augmente la possibilité d’avoir une maladie.Plus votre âge est élevé et plus vous êtes fragile.</p>
             </div>
            </div>  
        </div>
...
function Question11() {
    ...
    return (
        <div className="test1">
            ...
            <div class="card border-info mb-3 mb-3 container-lg" style={{maxWidth:700}}>
               <div class="card-header">La taille</div>
                <div class="card-body ">
                <img src="" class="im" alt=""/>
                 <p class="card-text">-Vous avez votre taille en vous mesurant des pieds à la tête.Votre poids et votre taille sont des facteurs de risque.Il faut calculer votre Indice de Masse Corporelle (IMC).L’IMC donne votre corpulence en faisant un calcul avec votre poids et votre taille.L’IMC permet de dire si vous être trop gros ou trop maigre,et donc plus ou moins fragile.</p>
             </div>
            </div> 
        ...
        <div className="test1">
            ...
            <div class="card border-info mb-3 mb-3 container-lg" style={{maxWidth:700}}>
               <div class="card-header">Le poids</div>
                <div class="card-body ">
                <img src="" class="im" alt=""/>
                 <p class="card-text">-Vous avez votre poids en vous pesant sur une balance.Votre poids et votre taille sont des facteurs de risque.Il faut calculer votre Indice de Masse Corporelle (IMC).L’IMC donne votre corpulence en faisant un calcul avec votre poids et votre taille.L’IMC permet de dire si vous être trop gros ou trop maigre,et donc plus ou moins fragile.</p>
             </div>
            </div>           
        </div>
        ...
        <div className="test1">
            ...
            <div class="card border-info mb-3 mb-3 container-lg" style={{maxWidth:500}}>
               <div class="card-header">L'hypertension artérielle</div>
                <div class="card-body ">
                <img src="" class="im" alt=""/>
                 <p class="card-text">-Une hypertension artérielle mal équilibrée,c'est une augmentation trop importante de la tension artérielle.La circulation du sang est trop rapide,donc le sang exerce une trop forte pression sur les artères.</p>
             </div>
            </div>
            <div class="card border-info mb-3 mb-3 container-lg" style={{maxWidth:500}}>
        ...
        <div className="test1">
            ...
            <div class="card border-info mb-3 mb-3 container-lg" style={{maxWidth:500}}>
               <div class="card-header">La maladie respiratoire</div>
                <div class="card-body ">
                <img src="" class="im" alt=""/>
                 <p class="card-text">-Une maladie respiratoire, c'est une maladie qui empêche de bien respirer.Cette maladie touche les organes qui sont nécessaires pour la respiration comme les poumons.Par exemple, on est vite essouflé quand on fait du sport et on tousse.</p>
             </div>
            </div>
            <div class="card border-info mb-3 mb-3 container-lg" style={{maxWidth:500}}>
               <div class="card-header">Le pneumologue</div>
                <div class="card-body ">
                <img src="" class="im" alt=""/>
                 <p class="card-text">-Un pneumologue, c'est le médecin des poumons,et des maladies liées aux poumons.Quand on a une maladie respiratoire,on va voir le pneumologue.</p>
             </div>
            </div>     
        </div>
        </div>
        ...
        <div className="test1">
            ...
            <div class="card border-info mb-3 mb-3 container-lg" style={{maxWidth:750}}>
               <div class="card-header">L'insuffisance rénale chronique</div>
                <div class="card-body ">
                <img src="" class="im" alt=""/>
                 <p class="card-text">-Une insuffisance rénale chronique, c'est une maladie des reins.Les reins ne fonctionnent plus correctement,ils filtrent mal le sang.Les reins n'éliminent plus les déchets qui sont dans le sang.Les déchets sont de plus en plus nombreux dans le sang,et le corps s'empoisonne.Ça nécessite un traitement par une dialyse.Une dialyse est une machine qui peut filtrer le sang.La dialyse filtre le sang à la place des reins de la personne.</p>
             </div>
            </div>   
        </div>
        ...
        <div className="test1">
            ...
            <div class="card border-info mb-3 mb-3 container-lg" style={{maxWidth:750}}>
               <div class="card-header">La maladie chronique du foie</div>
                <div class="card-body ">
                <img src="" class="im" alt=""/>
                 <p class="card-text">-La maladie chronique du foie,c'est lorsque notre foie ou une partie de notre foie ne fonctionne plus.Le foie nettoie le sang et donc le corps,et fabrique ce qui est essentiel pour la digestion et pour la bonne santé des muscles, de la peau, des os.Par exemple quand on boit beaucoup d'alcool ça peut abîmer notre foie.</p>
             </div>
            </div>    
        </div>
        ...
        <div className="test1">
            ...
            <div class="card border-info mb-3 mb-3 container-lg" style={{maxWidth:500}}>
               <div class="card-header">Enceinte</div>
                <div class="card-body ">
                <img src="" class="im" alt=""/>
                 <p class="card-text">-Une femme est enceinte quand elle attend un bébé.</p>
             </div>
            </div>  
        </div>
...
function Question20() {
    ...
    return (
        <div className="test1">
            ...
            <div class="card border-info mb-3 mb-3 container-lg" style={{maxWidth:800}}>
               <div class="card-header">Les défenses immunitaires</div>
                <div class="card-body ">
                <img src="" class="im" alt=""/>
                 <p class="card-text">-Les défenses immunitaires, ce sont les défenses du corps.Le corps a un système qui le protège contre toutes les infections, des microbes : bactéries, virus, etc...
        ...
        <div className="test1">
            ...
            <div class="card border-info mb-3 mb-3 container-lg" style={{maxWidth:700}}>
               <div class="card-header">Le code postal</div>
                <div class="card-body ">
                <img src="" class="im" alt=""/>
                 <p class="card-text">-Votre code postal est sur votre adresse.Il permet d'identifier le département et la ville où vous habitez.Le code postal est composé de 4 chiffres.Par exemple pour Tunis c'est le 1002 , pour Ariana c'est le 2080.</p>
             </div>
            </div>   
        </div>
